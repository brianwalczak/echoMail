...
export default function Home() {
    ...
    return (
        <>
            ...
            <div id="features" className="flex flex-col items-center justify-center pt-38 scroll-mt-[90px]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-7xl w-full px-4 md:px-8">
                    <div className="flex flex-col items-center text-center p-6 bg-white/5 border border-white/10 rounded-2xl">
                        <div className="w-16 h-16 bg-blue-600/20 text-blue-400 rounded-lg flex items-center justify-center mb-6">
            ...
            <div id="how-it-works" className="flex flex-col items-center justify-center pt-38 scroll-mt-[50px]">
                ...
                <div className="relative flex flex-col items-center w-full max-w-3xl px-4 md:px-8">
                    <div className="relative flex flex-col items-center text-center p-8 bg-white/5 border border-white/10 rounded-2xl mb-16 w-full">
                        <div className="absolute -top-8 left-1/2 -translate-x-1/2 w-16 h-16 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold text-2xl">1</div>
                    ...
                    <div className="relative flex flex-col items-center text-center p-8 bg-white/5 border border-white/10 rounded-2xl mb-16 w-full">
                        <div className="absolute -top-8 left-1/2 -translate-x-1/2 w-16 h-16 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold text-2xl">2</div>
                    ...
                    <div className="relative flex flex-col items-center text-center p-8 bg-white/5 border border-white/10 rounded-2xl w-full">
                        <div className="absolute -top-8 left-1/2 -translate-x-1/2 w-16 h-16 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold text-2xl">3</div>
            ...
            <div id="faq" className="flex flex-col items-center justify-center py-38">
